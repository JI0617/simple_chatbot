...
# session_state에 "messages"가 없으면 대화이력을 저장할 빈 리스트를 생성
...
# history_message_list = [("user", "입력내용")] -> MessagesPlaceholder(ChatPromptTempalte의 messages 형식)의 입력 형식임.
...
prompt = st.chat_input("챗봇에게 질문을 입력하세요.")    # 사용자가 입력한 문자열을 반환

## 대화작업
if prompt is not None:
    # session_state의 messages에 대화내역을 저장.
